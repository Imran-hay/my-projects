...
if(isset($_POST['change']))
{
  if(strlen($_POST['NPassword'])<8)
        ...
        if(preg_match("/[A-Z]/", $_POST['NPassword'])==0||preg_match("/[a-z]/", $_POST['NPassword'])==0||preg_match("/[0-9]/", $_POST['NPassword'])==0)
        {
         array_push($error,"Password must at least contain one capital letter one small and one number");

        }
        if($_POST['NPassword']!=$_POST['confirm'])
        {
        ...
        if(count($error)==0)
        {
          ...
          $sql=mysqli_query($con,"UPDATE customer SET pass='$pass' WHERE username='$value'");
          $state='Password succesfully changed';
        }
}
?>
      ...
      <div class="col-md-7 col-lg-8">
          ...
          <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" class="form-control" id="Name" name="Name" value="<?php echo $value ?>"readonly required>
              ...
              <div class="col-12">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="password" class="form-control " id="confirm" name="confirm" placeholder="Confirm Password" value="" required>
    </div>
                  <div class="error" style="color: red;">
       ...
       <?php  if (count($error) > 0) : ?>
    	...
    	<?php endforeach ?>
          ...
          <hr class="my-4">
          <button class="w-100 btn btn-success btn-lg m-2" type="submit" name="back" > Back to Landing Page</button>
