<?php
  if (!isset($_SESSION)) 
    ...
    include('public/customer.php');

  if(isset($_POST['seen']))
  { 
      $not_id=$_POST['not_id'];
      $sql=mysqli_query($con,"SELECT * FROM notifications WHERE id=$not_id");
      $row=mysqli_fetch_assoc($sql);
      $info=$row['info'];
      $order=$row['order_id'];
      if($info=='Your Order Has been denied, Your balance has been refunded')
      {
        $sqln=mysqli_query($con,"DELETE FROM notifications WHERE id=$not_id");
      header("Location: index.php");
      exit;
      }
      else
      if($info=='Confirmation of Delivery of Order!')
      {
        $sql2=mysqli_query($con,"UPDATE orders SET state=7 WHERE id=$order");
            $sqln=mysqli_query($con,"DELETE FROM notifications WHERE id=$not_id");
      header("Location: index.php");
      exit;
      }
                ...
                <a href="index.php" class="nav__logo"><i class='fas fa-bicycle'></i> hagere eat simple</a>
                    <?php
                        ...
                        { echo <<<_End
                                                ...
                                                <li class="nav__item"><a href="public/restaurants.php" class="nav__link">Restaurants</a></li>
                        ...
                        { echo <<<_End
                                                ...
                                                <li class="nav__item"><a href="public/receipt.php" class="nav__link">History</a></li>
                                                <li>
                                                ...
                                                <li><i class='bx bx-moon change-theme' id="theme-button" style="margin-right:7px;"></i></li>
                                                <li>
                                                <div class="icon" onclick="loadXMLDoc2();loadXMLDoc();toggleNotifi();">
                                                <i style='font-size:18px; margin-left: 5px; margin-top:2px; cursor:pointer;' class='far'>&#xf0f3;</i>
                                                <span id="num_notf">0</span>
                                                </div>
      ...
      <?php  if(isset($error)) :?>
       ...
       <?php  if (count($error2) > 0) : ?>
        ...
        <input type="text" name="username" id="username" placeholder="Username (must end with '@hes.com')" class="input-field" required
            ...
            <input type="password" name="password" id="password" placeholder="Password '8 Characters of capital, small and number'" class="input-field" required
                onchange="change6()"><span><img src="" id="v6" width="20px"></span>

            <input type="password" name="cpassword" id="cpassword" placeholder="Confirm Password" class="input-field"
...
<div class="a" id="overlay2" onclick="closeouter1()"></div> 
            ...
            <section class="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Hagere Eat Simple</h1>
                        <h2 class="home__subtitle">Try the best foods in <br> Addis.</h2>
                        <a href="public/restaurants.php" class="button">View Restaurants</a>
                    </div>
    
                    <img src="resources/img/home.png" alt="" class="home__img">
                </div>
            </section>
            ...
            <section class="about section bd-container">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">We deliver the best <br> tasty foods</h2>
                        <p class="about__description">We provide best foods in the entire city, with excellent customer service, the best meals and at the best price, visit us.</p>
                        <a href="public/about_us.php" class="button">Learn More</a>
                    </div>
            ...
            <section class="services section bd-container">
                ...
                <div class="services__container  bd-grid">
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">Fast and Reliable Service and Convenient.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">We deliver to your preferred location no inconvenience necessary</p>
                    </div>
                </div>
            </section>
            <!--========== CONTACT US ==========-->
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <p class="contact__description">If you any complaints or suggestion, contact us and we will attend to you quickly. </p>
                    </div>

                    <div class="contact__button">
                        <a href="public/about_us.php" class="button">Contact us now</a>
                    </div>
                </div>
            </section>
        </main>
        ...
        if (this.readyState == 4 && this.status == 200)
         document.getElementById("box").innerHTML = this.responseText;
            ...
            document.getElementById("box").innerHTML = "No Notifications"
        }
        // xhttp.open("GET", "filter.php")
        xhttp.open("GET", "shared/notification.php", true);
        xhttp.send();}
        ...
        xhttp.onload = function() {
        if (this.readyState == 4 && this.status == 200)
         document.getElementById("num_notf").innerHTML = this.responseText;
        else
            document.getElementById("num_notf").innerHTML = "0"
        }
        // xhttp.open("GET", "filter.php")
        xhttp.open("GET", "shared/notf_num.php", true);
        xhttp.send();}
